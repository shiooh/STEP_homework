...
free_listの末尾にダミーポインタがある理由で、「metadata が空き領域」 ⇔ 「metadata->next_free != NULL」という関係ができるのでこれで十分.

また、空き領域, 使用中領域を合わせたすべての領域を含めてアドレスの逆順に並べた単方向リスト neighbour を作成した。そうすると、左領域を free_head_list をすべて精査することなく O(1) で得られるようになった。
...
| Time1<br>[ms] | Utilization1<br>[%] | Time2<br>[ms] | Utilization2<br>[%] | Time3<br>[ms] | Utilization3<br>[%] | Time4<br>[ms] | Utilization4<br>[%] | Time5<br>[ms] | Utilization5<br>[%] |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 14 | 65 | 12 | 31 | 13 | 43 | 131 | 85 | 84 | 82 |
...
| merge_to_bothside | 13 | 63 | 12 | 26 | 14 | 38 | 95 | 84 | 66 | 81 |
